...
export class HourlySection extends Component {
    ...
    renderHourlyView(){
        if (this.props.weather){
            ...
            return(
                ...
                <Text style={{fontSize:20,color:'white',marginTop:10,paddingBottom:10,borderBottomWidth:1,borderBottomColor:'white',paddingLeft:10}} >Hourly</Text>
     
             <View style={{width:'80%',flexDirection:'row',marginTop:10,marginLeft:35,justifyContent:'space-between'}} >
               <Text style={{fontSize:15,color:'white'}} >9 AM</Text>
               <Text style={{fontSize:15,color:'white'}} >10 AM</Text>
               <Text style={{fontSize:15,color:'white'}} >11 AM</Text>
               <Text style={{fontSize:15,color:'white'}} >12 PM</Text>
             </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(HourlySection)
