...
import ForeCastMainView from './ForeCastPage/ForeCastMainView';
import Share, {ShareSheet, Button} from 'react-native-share';
import download from './TodayPage/download.png'
...
<Body>
  ...
  render() {
    ...
    let shareOptions = {
      title: "See My Forecast on WTHY ",
      message: "Howdy my Friends,See My Forecast on WTHY,It's on App Store and It's free ",
      url: "google play app",
      subject: "See the Link" //  for email
    };
    ...
    return (
      ...
      <Container>
        ...
        <Header hasTabs style={{backgroundColor:'#333333'}} androidStatusBarColor="#333333"  >
          ...
          <Icon color='white' onPress={()=>this.setState({visible:true })} size={20} name='share-alt' />
        ...
        <Tabs tabContainerStyle={{backgroundColor:'#333333'}}>
